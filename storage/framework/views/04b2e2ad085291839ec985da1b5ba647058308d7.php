<?php $__env->startSection('content'); ?>
    <div class="grid col-span-full">
        <h1 class="mb-5"><?php echo e(__('task.Edit task')); ?></h1>
        ...
        <div class="flex flex-col">
            ...
            <div class="mt-5">
                <?php echo e(Form::submit(__('task.Update'), ['class' => "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"])); ?>
