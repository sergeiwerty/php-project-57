        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a class="block py-2 pl-3 pr-4 text-gray-700 hover:text-blue-700 lg:p-0" href="<?php echo e(route('labels.index')); ?>">Метки</a>
                    </li>
                </ul>
            </div>
...
</header><?php /**PATH /home/user/development/php-project-lvl4/resources/views/shared/navbar.blade.php ENDPATH**/ ?>